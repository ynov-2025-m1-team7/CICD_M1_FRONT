    ...
    return (
        <div className="navbar">
            <div className="navbar__links">
                ...
                <NavButton text={"Notification"} image={'/assets/message.svg'} imageSelected={'/assets/message_selected.svg'} id={3} redirection={"/notification"} onClick={() => {navigate("/notification")}}/>
            </div>
        </div>
    );
}
